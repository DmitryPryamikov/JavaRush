...
public class Solution {
    ...
    protected void initThreads() {
        this.thread1 = new Thread(new Task(this, "A\tB\tC\tD\tE\tF\tG\tH\tI"),
                FIRST_THREAD_NAME);
    ...
    public String getPartOfString(String string, String threadName)  {
        ...
        int lastIndex = string.lastIndexOf(tabSymbol);

        returnString = string.substring(firstSymbol+1,lastIndex);
