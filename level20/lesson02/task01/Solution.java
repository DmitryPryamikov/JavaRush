...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = File.createTempFile("D:\\s.txt", null);
            ...
            if ((somePerson.name.equals(ivanov.name))&&(somePerson.assets.size()==ivanov.assets.size()))
            {
    ...
    public static class Human {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            String isNamePresented = name.isEmpty()?"no":"yes";
            ...
            //check assets
            String isAssetsPresented= assets.isEmpty()?"no":"yes";
